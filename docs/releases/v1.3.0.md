...
> **BROKEN -- DO NOT USE.** v1.3.0 fails at parse time due to a Groovy
> error in `subworkflows/local/realtime_monitoring/main.nf`. Use the
> v1.3.1 hotfix or the current stable v1.5.0 release instead. See
> [docs/validation/v1.3.0_warning.md](../validation/v1.3.0_warning.md)
> for full details. The release notes below are preserved as a record
> of what was intended to ship in this release.

**Release Date:** 2025-10-19
**Type:** Minor Release -- Performance Enhancements
**Status:** Broken (superseded by v1.3.1, then v1.5.0)
